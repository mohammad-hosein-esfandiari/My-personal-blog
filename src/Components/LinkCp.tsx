...
export const LinkCp: React.FC<any> = ({ link, name, title }) => {
  ...
  return (
    <Link
      onClick={addToStoreFunc}
      className=" p-6 flex rounded-md border-[#a8a8a845] border-[1px] items-center justify-center hover:bg-[#a8a8a845] cursor-pointer text-[#c1c1c1] hover:scale-[1.02] transition-all duration-300"
      href={link}>
